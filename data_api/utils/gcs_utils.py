...
def list_files_gcs(client_provider: GoogleClientProvider, prefix: str, extension: str) -> List[str]:
	return [
...
def download_textfile_as_string_gcs(client_provider: GoogleClientProvider, filepath: str) -> str:
	return client_provider.DATA_BUCKET.blob(filepath).download_as_text()
