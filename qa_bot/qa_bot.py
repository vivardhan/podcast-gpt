...
class QABot:
    ...
    def __init__(self):
        self.system_prompt = (
            "You answer the user's questions based on the provided context."
        )
        self.k = 4
    ...
    def construct_prompt(
        self, question: str, database_matches: List[DatabaseMatch]
    ) -> str:
        return "\n".join(
            [
                """
    ...
    def answer_question(self, question: str) -> None:
        ...
        return db_matches, self.client.chat.completions.create(
            messages=[
                ...
                {
                    "role": "user",
                    "content": self.construct_prompt(question, db_matches),
                },
            ],
    ...
    def answer_questions(self):
        print(
            "Hello, I answer questions based on 'The Huberman Lab Podcast' and 'The Peter Attia Drive Podcast'."
        )
        print(
            "When prompted, type your question and hit enter and I'll attempt to answer it."
        )
        print(
            "Once you're done, just type '{}' and hit enter.".format(self.quit_string)
        )
